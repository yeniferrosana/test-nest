  ...
  <footer class="bg-secondary-color-300">
    ...
    <div class="container px-5 py-10 mx-auto max-w-6xl">
      ...
      >
        ...
        <div>
          ...
          <div
            class="flex mt-5 mx-2 lg:justify-start sm:justify-start justify-center"
          >
            <a
              href="#"
              class="mx-2 text-primary-color transition-colors duration-300 hover:text-secondary-color"
              aria-label="Reddit"
            >
              <svg
    ...
    <div class="bg-secondary-color-200">
      <p class="text-center text-primary-color">
        ©2023 Donafunding - Todos los derechos reservados.
      </p>
    </div>
  </footer>
</template>
